...
public class AddBookController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException{
		...
		if(userID == null) {
			...
			if (!memberDAO.isAdmin(userID)) {
                ShowMessage.alertBack(res, "관리자만 도서를 등록할 수 있습니다.");
                return;
            }
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException{
        ...
        // 관리자 권한 확인
        if (userID == null || !memberDAO.isAdmin(userID)) {
            ShowMessage.alertBack(res, "관리자만 도서를 등록할 수 있습니다.");
            return;
        }
		...
		Book book = new Book(bookName, price, author, description, publisher, category, unitsInStock, totalPages, releaseDate, fileName);
